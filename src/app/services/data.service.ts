  ...
  public data = {
    ...
    about: {
      ...
      rows: [
        ...
        {
          title: 'Interests',
          content: 'Mobile/Web Development, Automation, Bioinformatics, Machine Learning, Blockchain',
        },
      ],
    },
    skills: [
    ...
    projects: [
      ...
      },
      {
        title: 'Bioterium',
        date: 'November 2013',
        description: 'A management software product developed for ICBAS animal facility as part of a college project.',
